                        ...
                        <ol class="breadcrumb justify-content-sm-end align-items-center">
                            <li class="breadcrumb-item">
                                <a href="#">
                                    <svg class="svg-color">
                                        <use
                                            href="{{ asset('assets/admin_pannel/edmin/assets/svg/iconly-sprite.svg#Home') }}">
                                        </use>
                                    </svg>
                                </a>
                            </li>
                            ...
                            <form class="theme-form row g-3 needs-validation custom-input" enctype="multipart/form-data"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <a href="#" class="mt-5 view-logo" data-bs-toggle="modal" data-bs-target="#imageModal"
                                        data-image="{{ isset($logos->header_logo) ? asset('storage/' . $logos->header_logo) : asset('images/logo-dark.png') }}">
                                        Show Logo
                                    </a>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <a href="#" class="mt-5 view-logo" data-bs-toggle="modal" data-bs-target="#imageModal"
                                        data-image="{{ isset($logos->footer_logo) ? asset('storage/' . $logos->footer_logo) : asset('images/logo-dark.png') }}">
                                        Show Logo
                                    </a>
                                    <div class="invalid-tooltip">
                                        Please enter a valid logo.
