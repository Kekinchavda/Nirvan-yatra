...
<head>
    ...
    <link rel="icon" href="{{ asset('assets/admin_pannel/edmin/assets/images/favicon/favicon.png') }}"
        type="image/x-icon">
    <link rel="shortcut icon" href="{{ asset('assets/admin_pannel/edmin/assets/images/favicon/favicon.png') }}"
        type="image/x-icon">
    ...
    <link rel="stylesheet"
        href="{{ asset('assets/admin_pannel/edmin/assets/js/vendors/flatpickr/dist/flatpickr.min.css') }}">
    <script src="{{ asset('assets/admin_pannel/edmin/assets/js/vendors/flatpickr/dist/flatpickr.js') }}"></script>
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin_pannel/edmin/assets/css/vendors/@yaireo/tagify/dist/tagify.css') }}">
